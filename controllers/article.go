...
func (ctrl ArticleController) Create(c *gin.Context) {
	...
	articleID, err := articleModel.Create(watcherID, articleForm)
...
func (ctrl ArticleController) All(c *gin.Context) {
	...
	data, err := articleModel.All(watcherID)
...
func (ctrl ArticleController) One(c *gin.Context) {
	...
	if id, err := strconv.ParseInt(id, 10, 64); err == nil {
		...
		data, err := articleModel.One(watcherID, id)
		if err != nil {
...
func (ctrl ArticleController) Update(c *gin.Context) {
	...
	if id, err := strconv.ParseInt(id, 10, 64); err == nil {
		...
		err := articleModel.Update(watcherID, id, articleForm)
		if err != nil {
...
func (ctrl ArticleController) Delete(c *gin.Context) {
	...
	if id, err := strconv.ParseInt(id, 10, 64); err == nil {
		...
		err := articleModel.Delete(watcherID, id)
		if err != nil {
